...
class Plugin
{
    ...
    protected function containDefaults()
    {
        ...
        $this->contain('settings', Settings::getInstance());
    }
    ...
    protected function build()
    {
        ...
        require_once $this->config['path']['plugin'] . 'settings.php';
        require_once $this->config['path']['plugin'] . 'init.php';
    }
